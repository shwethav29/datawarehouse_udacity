...
staging_events_table_create= ("""CREATE TABLE IF NOT EXISTS staging_events(user_id varchar,first_name varchar,last_name varchar,
gender varchar,level varchar, ts bigint,song_id varchar,artist_id varchar,session_id varchar,location varchar, length numeric(10,6),
user_agent varchar)
""")

staging_songs_table_create = ("""CREATE TABLE IF NOT EXISTS staging_songs(song_id varchar,title varchar, year int,
 duration numeric(10,6),artist_id varchar,name varchar, location varchar, latitude varchar, longitude varchar)
""")
